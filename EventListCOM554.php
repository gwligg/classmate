...
$sql = "SELECT class.ClassID, class.ModuleCode, class.Type, class.Room, class.StartTime, class.EndTime, class.DayOfWeek, class.StartDate, class.EndDate, module.ModuleTitle, Module.ModuleLecturer FROM class INNER JOIN module ON class.ModuleCode = module.ModuleCode WHERE class.ModuleCode='COM554'";
